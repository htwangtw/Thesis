...
Functional brain organization were long torn between the two extremes \textit{funtional specialization} and \textit{functional intergreation}. Functional specialization emphasizes that small, distinguishable brain regions are sovling distinct problems \cite{Kanwisher2010}. The history of functional specialization dates back to phrenology in the \nth{19} century. Brodmann area is defined by the histological structure and organization of brain cells in the early \nth(20) centry. Single-cell recordings and microscopic tissue examination revealed the segragation of occipital visual cortex \cite{•}. Lesion study on fusiform gyrus s
