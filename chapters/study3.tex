...
component 7 (\textit{F}(13, 160) = 2.239, \textit{p} = .010, \paretasqure = .154) 
and 12 (\textit{F}(13, 160) = 1.946, \textit{p} = .029, \paretasqure = .137). There was only one significant univeriate effect after Bonferroni correction, 
...
(\textit{F}(13, 160) = 1.924, \textit{p} = .031, \paretasqure = .135)
...
component 7 
(\textit{F}(13, 160) = 2.192, \textit{p} = .012, \paretasqure = .151)
and component 12
(\textit{F}(13, 160) = 2.312, \textit{p} = .008, \paretasqure = .158). There was only significant univeriate effect in the model for component 7 after Bonferroni correction. 
